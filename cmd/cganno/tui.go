...
type editModel struct {
	...
	// config.toml editor scratch (raw config; $CGANNO_HOME literals preserved)
...
// toConfig edits config.toml. It uses ReadConfigFile so $CGANNO_HOME literals round-trip
